...
import toyotaSupra from './assets/vehicle/toyotaSupra.jpg'
...
export const cars = [
    ...
    },
    {
        ...
        desc: 'Iconic muscle car, powerful engine, perfect for speed enthusiasts',
        image: dodgeChallenger,
        infoRecommendation: `The Dodge Challenger is a true icon of American muscle, 
    ...
    {
        name: 'Audi RS6',
        desc: 'Premium SUV, combines spacious interior with modern technology and quattro drive',
        image: audiQ7,
        infoRecommendation: `Audi RS6 Avant, 
        a high-performance luxury wagon that seamlessly blends power and sophistication.
    ...
    },
    {
        ...
        desc: 'Luxury sedan, elegant design with advanced safety and comfort features',
        image: dodgeCharger,
        infoRecommendation: `2018 Dodge Challenger,
    ...
    },  
    {
        ...
        desc: `The Chevrolet Silverado is a strong and reliable pickup truck. 
    ...
    },      
    {
        ...
        desc: `The McLaren P1 is a high-performance hybrid supercar.
         It offers incredible speed and cutting-edge technology. A thrill for both road and track.`,
        image: mcLarenP1,
